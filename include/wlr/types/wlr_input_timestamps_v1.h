...
struct wlr_input_timestamps_manager_v1 {
	...
	struct {
		...
		struct wl_signal new_keyboard_timestamps; // wlr_input_timestamps_v1
		struct wl_signal new_pointer_timestamps; // wlr_input_timestamps_v1
		struct wl_signal new_touch_timestamps; // wlr_input_timestamps_v1
	} events;
